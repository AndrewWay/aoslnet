...
pcdinputs="r11i02.Txt r11i03.Txt R12I03.Txt R12I05.Txt r12i08.Txt r12i10.Txt"
...
do
    ...
    pcdinput=`echo $pcdinputs | awk '{print $i}'`
    ./perdpcd.sh $id $year $pcdinput
    mongoimport -d aosldb -c bergpcd --file "$id"_pcd.json
done
